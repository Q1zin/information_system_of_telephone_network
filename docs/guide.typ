...
#where[Все таблицы создаются в `backend/migrations/0001…0014_*.sql`. Каждый файл — отдельный «шаг» создания базы. Визуально всю схему со связями видно в `docs/schema.dbml`.]
