...
docs/operations.pdf -- жизненный цикл: подключение, биллинг, долги (бизнес-сценарий)
docs/frontend.pdf -- устройство фронтенда (Vue SPA): конфиг-движок, что откуда появляется
